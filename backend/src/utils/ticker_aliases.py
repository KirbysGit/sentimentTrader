...
ticker_aliases: Dict[str, List[str]] = {
    ...
    "TCEHY": ["TENCENT"],
    "TBC": ["AT&T", "ATT", "AT&T INC", "AT&T CORPORATION", "AT&T GLOBAL NETWORK", "AT&T GLOBAL INFORMATION SOLUTIONS", "AT&T GLOBAL NETWORK SERVICES", "AT&T GLOBAL NETWORK SOLUTIONS", "AT&T GLOBAL NETWORK SERVICES", "AT&T GLOBAL NETWORK SOLUTIONS"],
